...
const Sidebar = ({ showSidebar, setShowSidebar }) => {
  ...
  const { role, successMessage, errorMessage } = useSelector(
    (state) => state.auth
  );
  ...
  return (
    <div>
      <div
        ...
        } w-screen h-screen bg-[#8cbce780] top-0 left-0 z-10`}></div>
      ...
      <div
        ...
        <div className="h-[100px] flex justify-center items-center">
          ...
          <Link to="/" className="w h-[80px]">
            {" "}
            {/* Increase Link wrapper size */}
