    ...
    <div className='w-full md:pl-4'>
        ...
        <div className='py-4'>
            <div className="bg-white shadow-sm rounded-lg p-4 border border-slate-200">
                <div className="bg-slate-50 h-[calc(100vh-290px)] rounded-lg p-3 overflow-y-auto">
                    {
                                ...
                                return (
                                    <div ref={scrollRef} key={i} className='w-full flex justify-start items-center'>
                                        <div className='flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]'>
                                            ...
                                            <div className='flex justify-center items-start flex-col w-full bg-slate-700 shadow-sm text-white py-2 px-3 rounded-lg'>
                                                <span>{m.message} </span>
                                            </div> 
                                        </div> 
                                    </div>
