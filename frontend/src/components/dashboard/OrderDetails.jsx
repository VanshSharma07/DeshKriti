...
const OrderDetails = () => {
    ...
    return (
        ...
        <h2 className='font-mono'>Price : {myOrder.price} INR Include Shipping</h2>
    ...
    <div className='mt-4'>
       ...
       <div className='flex text-sm flex-col justify-start items-start'>
        ...
        <div className='pl-4 flex flex-col'>
                <h2 className='text-md text-green-800'>{p.price - Math.floor((p.price * p.discount) / 100)} INR</h2>
                <p className='line-through'>{p.price} INR</p>
                <p>-{p.discount}%</p>
        </div>
        </div>
                </div>
