        ...
        <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto pb-16'>
           ...
           <div className='flex flex-col gap-5'>
            ...
            <div className='text-2xl text-red-500 font-bold flex gap-3 '>
                {
                    product.discount !== 0 ? <>
                    Price : <h2 className='line-through'>{product.price} INR</h2>
                    <h2>{product.price - Math.floor((product.price * product.discount) / 100)} INR (-{product.discount}%) </h2>
                    </> : <h2> Price : {product.price} INR</h2>
                }
...
<div className='pl-4 md-lg:pl-0'>
    ...
    <div className='flex flex-col gap-5 mt-3 border p-3'>
        ...
        <Link to={`/product/details/${p.slug}`} className='block'>
            ...
            <h2 className='text-lg font-bold text-slate-600'>{p.price} INR</h2>
