...
const Card = () => {
    ...
    return (
        <div>
           ...
           <section className='bg-[url("http://localhost:3000/images/banner/shop.png")] h-[220px] mt-4 bg-cover bg-no-repeat relative bg-left'>
    ...
    <div className='pl-4 sm:pl-0'>
        <h2 className='text-lg text-orange-500'>{pt.productInfo.price - Math.floor((pt.productInfo.price * pt.productInfo.discount) / 100)} INR</h2>
        <p className='line-through'>{pt.productInfo.price} INR</p>
    ...
    <div className='flex gap-2 flex-col'>
        ...
        text-white'>Delete</button>
                        ...
                        <div className='bg-white p-4'>
                        {
                                ...
                                <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
    <div className='pl-4 sm:pl-0'>
        <h2 className='text-lg text-orange-500'>{p.products[0].price - Math.floor((p.products[0].price * p.products[0].discount) / 100)} INR</h2>
        <p className='line-through'>{p.products[0].price} INR</p>
                            ...
                            <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
                            {
                                            card_products.length > 0 && (
                                                <div className='bg-white p-3 text-slate-600 flex flex-col gap-3'>
                                                    ...
                                                    {isCouponValid && <p className='text-green-500'>Coupon appliqué: -{discount} INR</p>}
                                                    <div className='flex justify-between items-center'>
                                                        <span>Total</span>
                                                        <span className='text-lg text-[#059473]'>{(price + shipping_fee) - discount} INR </span>
                                                    </div>
                                                    <button 
                                                        onClick={redirect} 
